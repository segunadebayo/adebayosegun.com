...
Over the past months years, we've been working hard to execute on the ideas described in [the future of Chakra UI](http://localhost:3000/blog/the-future-of-chakra-ui). Here's a quick overview of our architecture:
...
- **Headless UI components:** We're current working on [Ark UI](https://ark-ui.com/)
